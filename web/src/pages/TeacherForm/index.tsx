...
function TeacherForm() {
    ...
    function addNewScheduleItem() {
        setScheduleItems([
            ...scheduleItems, // este comando aqui, está copiando o scheduleItems para esse novo array que está sendo criado, porque o conceito de estado, substitui o array anterior, na linha abaixo adicionamos o novo valor (array.push)
            { week_day: 0, from: '', to: '' }
        ]);
    }
